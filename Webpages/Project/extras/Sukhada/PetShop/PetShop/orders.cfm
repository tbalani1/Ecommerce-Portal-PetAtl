...
<head>
	...
	<CFQUERY NAME="OrderHistory" DATASOURCE="UnivDB" DBTYPE="ODBC">
		...
		VALUES ((SELECT MAX(IDORDER)+1 FROM ORDEREDPRODUCT),112034, '15-Nov-2017', (SELECT MAX(IDADDRESS) FROM ADDRESS), 2001);
	</CFQUERY>
	<CFQUERY NAME="OrderProduct" DATASOURCE="UnivDB" DBTYPE="ODBC">
		...
		VALUES (10003, (SELECT MAX(IDORDER) FROM ORDEREDPRODUCT), 'Y', 60.00, 76.00, '15-Nov-2017', 'SHIPPED');
	</CFQUERY>

...
<head>
  ...
  <title>PetAtl | Payment Information</title>
...
<body class="payments-page">
  <header>
    ...
    <ul class="main-header clearfix">
      <a href="products.cfm" class="main-logo white-text">PetAtl2</a>
  ...
  <FORM name="PaymentForm" action="login.cfm" method="post">
    ...
    <div class="button-wrapper">
	  ...
	  <input type="Submit" class="btn btn-primary pull-right" value="Continue" onclick="showMsg()">
    </div>
	</form>
  </section>
  <footer>
